        ...
        <div className='w-full'>
            <nav className='flex justify-between'>
                <div className='pt-10 font-bold text-l tracking-wide'>
                    <button className={classActive} onClick={(e) => handleClick(e)}>Latest</button>
                    <button className={classInactive} onClick={(e) => handleClick(e)}>All</button>
                    <button className={classInactive} onClick={(e) => handleClick(e)}>WebDev</button>
                </div>
                <div>
